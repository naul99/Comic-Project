! function(t, e) {
    ...
    var v = function() {
        ...
        E = function() {
            function e(i, n) {
                t(this, e), _ += 1, this.id = _, this.element = i, this.isRTL = n, this.isVisible = !0, this.isHidden = !1
            }
            return i(e, [{
                key: "show",
                value: function() {
                ...
                key: "init",
                value: function() {
                    this.addClasses([g.SHUFFLE_ITEM, g.VISIBLE]), this.applyCss(e.Css.INITIAL), this.applyCss(this.isRTL ? e.Css.DIRECTION.rtl : e.Css.DIRECTION.ltr), this.scale = e.Scale.VISIBLE, this.point = new v
                }
            }, {
                key: "addClasses",
                value: function(t) {
    ...
    function T(t, e) {
        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : window.getComputedStyle(t, null),
            n = m(i[e]);
        return b() || "width" !== e ? b() || "height" !== e || (n += m(i.paddingTop) + m(i.paddingBottom) + m(i.borderTopWidth) + m(i.borderBottomWidth)) : n += m(i.paddingLeft) + m(i.paddingRight) + m(i.borderLeftWidth) + m(i.borderRightWidth), n
    }
    var S = {
        reverse: !1,
        by: null,
    ...
    function D(t) {
        return !!C[t] && (C[t].element.removeEventListener(L, C[t].listener), C[t] = null, !0)
    }
    ...
    function z(t, e) {
        ...
        return t.addEventListener(L, n), C[i] = {
            element: t,
            listener: n
        }, i
    }
    ...
    var N = 0,
        B = function(e) {
            ...
            function o(e) {
                ...
                return i.element = r, i.id = "shuffle_" + N, N += 1, i._init(), i.isInitialized = !0, i
            }
            return i(o, [{
                key: "_init",
                value: function() {
                ...
                value: function(t, e) {
                    var i = this,
                        n = [],
                        s = [];
                    return t === o.ALL_ITEMS ? n = e : e.forEach((function(e) {
                ...
                value: function(t, e) {
                    ...
                    return Array.isArray(t) ? this.options.filterMode === o.FilterMode.ANY ? t.some(s) : t.every(s) : n.includes(t)
                }
            }, {
                ...
                value: function(t, e) {
                    var i;
                    return 0 === (i = "function" == typeof this.options.columnWidth ? this.options.columnWidth(t) : this.options.sizer ? o.getSize(this.options.sizer).width : this.options.columnWidth ? this.options.columnWidth : this.items.length > 0 ? o.getSize(this.items[0].element, !0).width : t) && (i = t), i + e
                }
            }, {
                key: "_getGutterSize",
                value: function(t) {
                ...
                value: function(t) {
                    return function(t) {
                        for (var e = t.itemSize, i = t.positions, n = t.gridSize, s = t.total, o = t.threshold, r = t.buffer, l = A(e.width, n, s, o), a = F(i, l, s), u = x(a, r), h = new v(n * u, a[u]), f = a[u] + e.height, c = 0; c < l; c++) i[u + c] = f;
                        return h
                    }({
                        itemSize: t,
                ...
                key: "_cancelMovement",
                value: function() {
                    this._transitions.forEach(D), this._transitions.length = 0, this.isTransitioning = !1
                }
            }, {
    ...
    return B.ShuffleItem = E, B.ALL_ITEMS = "all", B.FILTER_ATTRIBUTE_KEY = "groups", B.EventType = {
        LAYOUT: "shuffle:layout",
        REMOVED: "shuffle:removed"
    }, B.Classes = g, B.FilterMode = {
        ANY: "any",
        ALL: "all"
    }, B.options = {
        group: B.ALL_ITEMS,
        ...
        isRTL: !1,
        roundTransforms: !0
    }, B.Point = v, B.Rect = y, B.__sorter = k, B.__getColumnSpan = A, B.__getAvailablePositions = F, B.__getShortColumn = x, B.__getCenteredPositions = O, B
}));
